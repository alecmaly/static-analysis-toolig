...
// Constants
const storagePath : string = "./.vscode/ext-detectors"; // Directory relative to workspace to store files
...
export const storageFiles = {
    analysis: "detector-results.json", // file where analysis results will be stored
    detector_details: "slither-detectors.json" // file where detector details will be stored
}
...
const defaultConfiguration : UserConfiguration = {
    ...
    slitherTarget: ".",
    slitherArgs: "", // arguments to pass to Slither
    slitherCmdPrefix: "" // cmd prefix (e.g. source /user/x/.bashrc)
}
